...
public interface PacketFactory<T> {
   ...
   */
  T createSpawnPacket(final int id, @NotNull SerializableLocation displayLocation);
   ...
   */
  T createMetaDataPacket(final int id, @NotNull SerialItem<?> itemStack);
 ...
 */
   ...
   */
  boolean sendPacket(@NotNull PlayerProvider player, @NotNull T packet);
